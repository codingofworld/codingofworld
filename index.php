...
?>
    ...
    <main class="main-area fix">
                        ...
                        <div class="banner__images">
                            ...
                            <div class="banner__author">
                                <div class="banner__author-item">
                                    ...
                                    <h6 class="name">Robin Mishra</h6>
                                </div>
                                <div class="banner__author-item">
                                    <div class="image">
                                        <img src="assets/img/banner/banner_author02.png" alt="img">
                                    </div>
                                    <h6 class="name">Vimal Raj</h6>
                                </div>
        ...
        <!-- course-area -->
        <section class="courses-area pt-5 section-pb-90" data-background="assets/img/bg/courses_bg.jpg">
            <div class="container">
                <div class="section__title-wrap mb-1">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="section__title text-center mb-40">
                                <span class="sub-title">Our Best Training</span>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" aria-labelledby="all-tab" tabindex="0">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                    ...
                    <div class="col-lg-6 col-md-9">
                        <div class="about__images">
                            ...
                            <div class="about__enrolled" data-aos="fade-right" data-aos-delay="200">
                                <p class="title"><span>6K+</span> Enrolled Students</p>
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            <div class="section__title">
                                ...
                                <h2 class="title">
                                    ...
                                    <span class="position-relative">
                                        ...
                                        codeservir
                                    </span>Learning Academy
                                </h2>
                            </div>
                            <p class="desc">Welcome to CodeServir, your faithful gateway to success in the dynamic world
                                of Information Technology. As a leading and fast-growing organization, we are dedicated
                                to our students' bright futures. We take immense pride in our recognition as the best IT
                                training institute in Lucknow, and we're thrilled to be your partner on your journey
                                toward a rewarding career.
                                <br>
                                In an era defined by rapid technological advancements, having the right skills and
                                knowledge is crucial for success. CodeServir is deeply committed to the ever-evolving IT
                                landscape and is dedicated to providing top-tier training to equip you for this dynamic
                                field.
                            </p>
                            <div class="work__list-wrap">
                                ...
                                <div class="work__list-box">
                                    <div class="work__list-box-top">
                                        ...
                                        <h4 class="title">Shaping the Future!</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tg-button-wrap">
                                <a href="about-us.html" class="btn arrow-btn">More About<img
                                        src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- about-area-end -->
        <!-- categories-area -->
        <section class="categories-area  section-pb-90">
            <div class="container">
                <div class="row justify-content-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Software Development</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Data Science & Analytics</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="categories__item">
                                            <a href="courses.html">
                                                ...
                                                <span class="name">Video / Animation</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        ...
                                        <div class="courses__item-content">
                                            ...
                                            <h5 class="title"><a href="course-details.html">Learning Laravel Full Course<br> ( Zero to Hero )</a></h5>
                                            <div class="courses__item-bottom">
                                                <div class="button">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        ...
                                        <div class="courses__item-content">
                                            ...
                                            <h5 class="title"><a href="course-details.html">The Complete Ai Course
                                                    for Beginners</a></h5>
                                            <div class="courses__item-bottom">
                                                <div class="button">
                                                    <a href="course-details.html">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        ...
                                        <div class="courses__item-content">
                                            ...
                                            <h5 class="title"><a href="course-details.html">Learning Digital Marketing
                                                    on Facebook</a></h5>
                                            <div class="courses__item-bottom">
                                                <div class="button">
                                                    <a href="course-details.html">
        ...
        <!-- fact-area-two -->
        <section class="fact__area-two  section-py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="fact__inner-wrap-two">
                            ...
                            <div class="fact__item-wrap">
                                <div class="fact__item">
                                    <h2 class="count"><span class="odometer" data-count="6"></span>K+</h2>
                                    <p>Active Students</p>
                                </div>
                                <div class="fact__item">
        ...
        <!-- faq-area -->
        <section class="faq__area py-5 mt-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="faq__content">
                            ...
                            <p>Empowering Minds, Shaping Futures: Your Journey to Expertise Begins Here at CodeServir.</p>
                            <div class="faq__wrap">
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                What courses do you offer at CodeServir?
                                            </button>
                                        </h2>
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>We offer a wide range of courses, including Software Development, Web Development, Data Science, Digital Marketing, Mobile App Development, and more. Our courses are designed to equip you with the skills needed in today’s competitive job market.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>Our instructors are industry experts with years of professional experience in their respective fields. They bring real-world insights and hands-on experience to the classroom, ensuring you get practical, applicable knowledge.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>Yes, we provide industry-recognized certifications upon successful completion of each course. These certifications are valuable credentials that can help boost your career prospects.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p>Some of our advanced courses may require prior knowledge or experience in specific areas. However, we also offer beginner-level courses with no prerequisites, making it easy for anyone to start learning.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="section__title white-title text-center mb-50">
                            ...
                            <p>CodeServir’s intuitive shared platform unites team members, enabling them to organize, prioritize, and collaborate efficiently. In this episode.</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title">What Students Think and Say About codeservir</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
