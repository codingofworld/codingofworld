                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info list-wrap">
                            <li><img src="assets/img/icons/map_marker.svg" alt="Icon"> <span>4/37 Vibhav Khand Gomti Nagar, Lucknow, Uttar Pradesh, 226010
                            </span></li>
                            <li><img src="assets/img/icons/envelope.svg" alt="Icon"> <a
                                    href="mailto:info@codeservir.com">info@codeservir.com</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <div class="tg-header__top-right">
                            <div class="tg-header__phone">
                                <img src="assets/img/icons/phone.svg" alt="Icon">Call us: <a href="tel:9455791624">+91 945-579-1624</a>
                            </div>
                                ...
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="menu-item-has-children"><a href="javascript:void(0)">Courses</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item-has-children"><a href="javascript:void(0)">Web
                                                        Development</a>
                                                ...
                                                <li class="menu-item-has-children"><a
                                                        href="javascript:void(0)">Programming Language</a>
                                                ...
                                                <li class="menu-item-has-children"><a href="javascript:void(0)">App
                                                        Development</a>
                                                    <ul class="sub-menu" id="sub-menu-3" style="display: block;">
                                                        <li class="border-look" value="43"><a
                                        ...
                                        <li class="menu-item-has-children"><a href="javascript:void(0)">Training</a>
                                            <ul class="sub-menu">
